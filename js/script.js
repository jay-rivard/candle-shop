    ...
    itemContainer.innerHTML =  
        `<div class="row text-center">
            <div class="col-sm recommended-box d-flex flex-column">
                ...
                <a class="recommended-box-text" href="../html/item.html?id=${products[0].id}">${products[0].title}</a>
            ...
            <div class="col-sm recommended-box d-flex flex-column">
                <button type="button" class="btn add-to-cart" id="add-to-cart">ADD TO CART</button>
                <div class="recommended-box-info">
                <a class="recommended-box-text" href="../html/item.html?id=${products[1].id}">${products[1].title}</a>
            ...
            <div class="col-sm recommended-box d-flex flex-column">
                <button type="button" class="btn add-to-cart" id="add-to-cart">ADD TO CART</button>
                <div class="recommended-box-info">
                <a class="recommended-box-text" href="../html/item.html?id=${products[2].id}">${products[2].title}</a>
    ...
    if(document.URL.includes("/fall.html")){
        if(item.season == "fall") {
            saleSeasonContainer.innerHTML += `<div class="col-sm recommended-box d-flex flex-column">
                                            <button type="button" class="btn add-to-cart" id="add-to-cart">ADD TO CART</button>
                                            <div class="recommended-box-info">
                                                <a class="recommended-box-text" href="../html/item.html?id=${item.id}">${item.title}</a>
        ...
        if(item.cart == true) {
            ...
            cartContainer.innerHTML  +=      `<hr>
                                    <div class="flex-row cart-container d-flex">
                                        ...
                                        <p class="d-block cart-text"><a class="recommended-box-text cart-link" href="../html/item.html?id=${item.id}"><b>${item.title}</b></a><br>$${item.price}.00<br><br><br>______<br>Wick Type: ${item.wickType}<br>Color: ${item.color}<br>Scent: ${item.scent}</p>
...
products.forEach(function(item) {
    ...
    const itemTemplate =    `<div class="col-md-2 col-sm-5 col-12 search-result-item top d-flex flex-column">
                                <button type="button" class="btn add-to-cart" id="add-to-cart">ADD TO CART</button>
                                <div class="recommended-box-info">
                                    <a href="../html/item.html?id=${item.id}" class="item-title">${item.title}</a>
